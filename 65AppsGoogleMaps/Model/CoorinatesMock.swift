...
struct CoordinatesMock {
    ...
    let data = [Point(lattitude: 60.1841232, longitude: 24.9276637,  title: "Helsinki", snippet: "Kamppi", locationTypeID: .zero),
                ...
                Point(lattitude: 60.3176409, longitude: 24.9651579,  title: "Vantaa", snippet: "Airport"),
                Point(lattitude: 59.9905525, longitude: 29.7787134,  title: "Санкт-Петербург", snippet: "Кронштадт"),
                Point(lattitude: 59.8826789, longitude: 29.9038036,  title: "Санкт-Петербург", snippet: "Петергоф"),
